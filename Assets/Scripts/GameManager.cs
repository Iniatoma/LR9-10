...
public class GameManager : MonoBehaviour
{
    ...
    private void Start() // измен€ет состо€ние игры, генериру€ новый уровень
    {
    ...
    private void Update() // управление в игре на стрелки "вверх", "вниз", "вправо", "влево"
    {
    ...
    private void GenerateGrid() // создание сетки объектов на сцене, где вызываетс€ префаб объекта Node, либо по координате x или y
    {
        _round = 0;
    ...
    void MergeBlocks(Block baseBlock, Block mergingBlock) // объединение блоков и удаление их после
    {
